...
(declare-const renamed-copy Bool)
(declare-const second-hop Bool)
...
(assert (= renamed-copy reference-valid))
(assert (= second-hop renamed-copy))
(assert (= implementation-accept
  (ite (= implementation 0) second-hop true)))
...
(push) (assert (= implementation 1)) (assert (= scenario 1)) (assert disagreement) (check-sat) (pop)
